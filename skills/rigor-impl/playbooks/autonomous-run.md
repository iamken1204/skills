...
1. State the exit condition as a checkable predicate before the first iteration (tests green, repro fixed, all N units verified, pixel-diff zero).
...
5. Checkpoint every iteration via `references/decision-trail.md`, a row for what changed and whether the predicate moved.
