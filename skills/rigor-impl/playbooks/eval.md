...
- No chain-eliciting cues. Don't ask the candidate to list which skills or principles it applied. Ask for design notes generally and grade chain-following from code shape, not self-report.
